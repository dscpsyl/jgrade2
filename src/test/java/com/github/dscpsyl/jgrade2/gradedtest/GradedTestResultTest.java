...
public class GradedTestResultTest {
  ...
  public void initUnit() {
    this.unit = new GradedTestResult(
        GradedTestResult.DEFAULT_NAME, GradedTestResult.DEFAULT_NUMBER,
        GradedTestResult.DEFAULT_POINTS, GradedTestResult.DEFAULT_VISIBILITY);
  }
  ...
  public void cannotAddScoreGreaterThanPoints() {
    assertThrows(RuntimeException.class, () -> { unit.setScore(15.0); });
  }

  @Test
  public void visibilityMustBeValid() {
    assertThrows(IllegalArgumentException.class, () -> {
      new GradedTestResult(GradedTestResult.DEFAULT_NAME,
