...
public class GradedTestListenerTest {
  ...
  private GradedTestResult
  getOnlyGradedTestResult(Class<?> exampleUnitTests,
                          GradedTestListener listener) {
  ...
  public void addsDefaultGradedTestResult() {
    GradedTestResult result =
        getOnlyGradedTestResult(SingleDefaultGradedTest.class, this.listener);
  ...
  public void addsCustomGradedTestResult() {
    GradedTestResult result =
        getOnlyGradedTestResult(SingleCustomGradedTest.class, this.listener);
  ...
  public void correctlyCountsFailedGradedTest() {
    GradedTestResult result =
        getOnlyGradedTestResult(SingleFailedGradedTest.class, this.listener);
  ...
  public void capturesOutputFromTest() {
    GradedTestResult result =
        getOnlyGradedTestResult(TestWithOutput.class, this.listener);
    assertEquals(EXAMPLE_STRING, result.getOutput());
  }

  @Test
  public void outputHasFailMessage() {
    GradedTestResult result = getOnlyGradedTestResult(
        SingleFailWithMessageGradedTest.class, this.listener);
  ...
  public static class SingleCustomGradedTest {
    @Test
    @GradedTest(name = EXAMPLE_NAME, number = EXAMPLE_NUMBER,
                points = EXAMPLE_POINTS, visibility = GradedTestResult.HIDDEN)
    public void
    gradedTest() {
      assertTrue(true);
    }
