...
public class GradeHello {
  ...
  public void debugMode(Grader grader) {
    if (HelloTest.DEBUG) {
      GradedTestResult r = new GradedTestResult("Debug Mode Warning", "", 0.0,
                                                GradedTestResult.HIDDEN);
  ...
  public void runCheckstyle(Grader grader) {
    ...
    CheckstyleGrader checker =
        new CheckstyleGrader(10.0, 1.0, "../lib/checkstyle-8.12-all.jar",
                             "../src/main/java/student/hello/");
