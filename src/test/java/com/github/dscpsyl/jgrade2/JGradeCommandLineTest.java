...
public class JGradeCommandLineTest {
  ...
  public void acceptsMultipleFlags() throws IOException {
    JGrade2.main(
        new String[] {"-f", "json", "-c", this.getClass().getCanonicalName()});
  }

  @Test
  public void acceptsLongOption() throws IOException {
    JGrade2.main(new String[] {"--format", "json", "-c",
  ...
  public void rejectsInvalidFormatArguments() throws IOException {
    assertThrows(RuntimeException.class, () -> {
      JGrade2.main(new String[] {"-f", "invalid", "-c",
                                 this.getClass().getCanonicalName()});
    });
  }
  ...
  public void graderMethod(Grader g) {
    g.addGradedTestResult(new GradedTestResult("Test GradedTestResult", "1",
                                               25.0, GradedTestResult.VISIBLE));
  }
}
