...
if [ "$1" = "--local" ]; then
    java -jar ../lib/jgrade2-2.0.0-a2-all.jar -c staff.hello.GradeHello --pretty-print
else
    java -jar ../lib/jgrade2-2.0.0-a2-all.jar -c staff.hello.GradeHello -o /autograder/results/results.json
fi
