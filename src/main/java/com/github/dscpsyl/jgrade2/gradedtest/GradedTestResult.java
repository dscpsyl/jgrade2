...
public class GradedTestResult {
   ...
   */
  public GradedTestResult(String name, String number, double points,
                          String visibility) throws IllegalArgumentException {
    this.name = name;
    this.number = number;
    this.points = points;
    ...
    if (!(visibility.equals(HIDDEN) || visibility.equals(VISIBLE) ||
      ...
      throw new IllegalArgumentException(
          "visibility should be one of 'hidden', 'visible', "
   ...
   */
  public void addOutput(String s) { this.output.append(s); }
