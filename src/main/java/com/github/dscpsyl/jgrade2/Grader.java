...
public class Grader {
   ...
   */
  public void setGraderStrategy(GraderStrategy s) { this.graderStrategy = s; }
  ...
  public void stopTimer() throws IllegalStateException {
    ...
    this.setExecutionTime(this.getExecutionTime() + System.currentTimeMillis() -
                          this.startTime);
    this.startTime = 0;
  }
   ...
   * for all {@link com.github.dscpsyl.jgrade2.gradedtest.GradedTest}s and add
  ...
  public void runJUnitGradedTests(Class<?> testSuite) {
    ...
    // Get the results from the listener, grade them, and add them to the
    // Grader.
