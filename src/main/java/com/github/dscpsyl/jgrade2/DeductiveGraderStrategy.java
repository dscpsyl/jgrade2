...
public class DeductiveGraderStrategy implements GraderStrategy {
   ...
   */
  public double getDeductedPoints() { return this.deductedPoints; }
  ...
  public void grade(List<GradedTestResult> l) {
    ...
    GradedTestResult baseScore = new GradedTestResult(
        sectionName, "", startingScore, GradedTestResult.HIDDEN);
